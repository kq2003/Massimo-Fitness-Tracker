...
const QueryData: React.FC = () => {
    ...
    const [viewType, setViewType] = useState<string>('Strength');
    const [exerciseType, setExerciseType] = useState<string>('');
    const [strengthExerciseTypes, setStrengthExerciseTypes] = useState<string[]>([]);
    const [aerobicExerciseTypes, setAerobicExerciseTypes] = useState<string[]>([]);
    ...
    const handleViewTypeChange = (e: ChangeEvent<HTMLSelectElement>) => {
        setViewType(e.target.value);
        setExerciseType(''); // Reset exercise type when view type changes
    };

    const handleExerciseTypeChange = (e: ChangeEvent<HTMLSelectElement>) => {
