...
const UserAuth: React.FC = () => {
    ...
    const [loginData, setLoginData] = useState<LoginData>({ username: '', email: '', password: '' }); ///////////////////////Type mismatch; added username for now
                                ...
                                showRegister ? (
                                    <>
                                        ...
                                        <Form onSubmit={handleRegisterSubmit}>
                                            ...
                                            <Button variant="link" onClick={() => setShowRegister(false)} className="w-100">
                                                Go to Login
                                            </Button>
                                        </Form>
                                    </>
                                    ...
                                    <>
                                        ...
                                        <Form onSubmit={handleLoginSubmit}>
                                            ...
                                            <Button variant="link" onClick={() => setShowRegister(true)} className="w-100">
                                                Register
                                            </Button>
                                        </Form>
                                    </>
