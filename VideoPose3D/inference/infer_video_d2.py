    ...
    for video_name in im_list:
        ...
        for frame_i, im in enumerate(read_video(video_name)):
            ...
            if has_bbox:
                ...
                kps = np.empty((0, 3, 17))  # Assuming 17 keypoints
                bbox_tensor = np.empty((0, 5))  # Empty bounding boxes
        ...
        # Convert lists to arrays with dtype=object
        ...
        #     ###############################
        #     print("Boxes shape:", np.array(boxes, dtype=object).shape)
        #     print("Segments shape:", np.array(segments, dtype=object).shape)
        #     print("Keypoints shape:", np.array(keypoints, dtype=object).shape)
